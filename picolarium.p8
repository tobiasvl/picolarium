...
function _update()
  ...
  elseif mode==modes.level_select then
    ...
    menuitem(1)
    menuitem(2)
    if (custom) menuitem(1,"main menu",function() cls() palt(0,false) mode=modes.custom_submenu music(0) end)
    if btnp(⬅️) then
...
__sfx__
01010000242313062124611186110f0000f0000f0000f0000f0000f0000f0000f0000f0000f0000f000178001e8002180027800330003300033000330003300033000270002100019000150000f0000f0010f000
